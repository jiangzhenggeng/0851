...
function template($module = 'content', $template = 'index', $style = '') {
	...
	if(1 || file_exists(PC_PATH.'templates'.DIRECTORY_SEPARATOR.$style.DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR.$template.'.html')) {
		if(1 || !file_exists($compiledtplfile) || (@filemtime(PC_PATH.'templates'.DIRECTORY_SEPARATOR.$style.DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR.$template.'.html') > @filemtime($compiledtplfile))) {
...
function catpos($catid, $symbol=' > '){
	...
	$pos_end = strrpos($pos,$symbol);
    $pos = substr($pos,0,$pos_end);
	return $pos;
}
