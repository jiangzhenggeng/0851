...
<fieldset>
	...
	<table width="100%" class="table_form">
		<tr>
			...
			<td><?php if(in_array($groupid, array(-1/*1,7,8*/))) { echo $groupinfo['name'];} else {?><input type="text" name="info[name]"  class="input-text" id="name" value="<?php echo $groupinfo['name']?>"><?php }?></td>
		</tr>
		<tr>
